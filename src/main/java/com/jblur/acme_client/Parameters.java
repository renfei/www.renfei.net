...
public class Parameters {
    ...
    */
    ...
    public String workDir = "/var/acme_work_dir/";
    ...
    public String certDir = this.workDir + "cert/";
    ...
    public String logDir = "/var/log/acme/";
    ...
    public String wellKnownDir = this.workDir + "well_known/";

    @Parameter(names = {"--dns-digests-dir"}, description = "Directory to save DNS digest files to.")
    public String dnsDigestDir = this.workDir + "dns_digests/";
    ...
    public String acmeServerUrl = "https://acme-v02.api.letsencrypt.org/directory";
    ...
    public boolean oneDirForWellKnown;
    ...
    public String challengeType = CHALLENGE_HTTP01;
    ...
    public boolean withAgreementUpdate;
