                            ...
                            <form>
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group-prepend">
                                        <div class="btn btn-primary align-middle copyPaswd" data-clipboard-target="#result">复制</div>
                                    </div>
                                </div>
                                ...
                                <button type="button" class="btn btn-primary btn-block" id="generate" onclick="onGeneratePassword()">生成密码</button>
                            </form>
                            <div class="row mt-3">
                                <div class="col-md-12">
