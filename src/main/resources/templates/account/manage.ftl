            ...
            <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>用户名</label>
                            <label class="form-control account_info_label">${user.userName!'-'}</label>
                        </div>
                        <div class="form-group">
                            <label>注册时间</label>
                            <label class="form-control account_info_label">${user.registrationDate!?string("yyyy-MM-dd hh:mm:ss")}</label>
                        </div>
                        <div class="form-group">
                            <label>姓氏</label>
                            <label class="form-control account_info_label">${user.lastName!'-'}</label>
                            <small class="form-text text-muted"><a href="/account/manage/firstName">修改我的姓氏...</a></small>
                        </div>
                        <div class="form-group">
                            <label>名字</label>
                            <label class="form-control account_info_label">${user.firstName!'-'}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>电子邮箱</label>
                            <label class="form-control account_info_label">${user.email!'-'}</label>
                            <small class="form-text text-muted"><a href="/account/manage/email">修改电子邮箱地址...</a></small>
                        </div>
                        <div class="form-group">
                            <label>手机号码</label>
                            <label class="form-control account_info_label">${user.phone!'-'}</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <label class="form-control account_info_label">${(user.totp??)?string('已开启','未开启')}</label>
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>用户组</label>
                                <label class="form-control account_info_label">${discuzInfo.userGroup!'-'}</label>
                            ...
                            <div class="form-group">
                                <label>帖子数</label>
                                <label class="form-control account_info_label">${discuzInfo.postsCount!?c}</label>
                                <small class="form-text text-muted"><a
                                            href="https://bbs.renfei.net/forum.php?mod=guide&view=my" target="_blank">前往查看...</a></small>
                            </div>
                            <div class="form-group">
                                <label>在线时间</label>
                                <label class="form-control account_info_label">${discuzInfo.oltime!?c} 小时</label>
                                <small class="form-text text-muted"><a
                            ...
                            <div class="form-group">
                                <label>精华数</label>
                                <label class="form-control account_info_label">${discuzInfo.essenceCount!?c}</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>积分</label>
                                <label class="form-control account_info_label">${discuzInfo.points!?c}</label>
                                <small class="form-text text-muted"><a
                            ...
                            <div class="form-group">
                                <label>金钱</label>
                                <label class="form-control account_info_label">${discuzInfo.money!?c}</label>
                            </div>
                            <div class="form-group">
                                <label>威望</label>
                                <label class="form-control account_info_label">${discuzInfo.prestige!?c}</label>
                            </div>
                            <div class="form-group">
                                <label>贡献</label>
                                <label class="form-control account_info_label">${discuzInfo.contribution!?c}</label>
                            </div>
                        </div>
                    </div>
                </div>
